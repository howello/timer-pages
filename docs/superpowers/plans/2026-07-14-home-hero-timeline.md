...
- [ ] **Step 2: 新增 `getHeroMoments(cards)`**
...
- [ ] **Step 3: 新增 `formatMomentCountdown(card)`**
...
- [ ] **Step 4: 新增 `formatMomentDateParts(card, target)`**
...
- [ ] **Step 3: 复核 `bindScrollReveal` 滚动揭示阈值**
